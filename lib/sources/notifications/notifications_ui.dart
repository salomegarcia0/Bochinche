...
void showNotifications(BuildContext context, {required Function(Map<String, dynamic>) onEventSelected}) {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text(
                  "Notificaciones",
                  style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: PrimaryPurple),
                ),
                TextButton(
                  onPressed: () {
                  },
                ...
                builder: (context, snapshot) {
                  ...
                  if (docs.isEmpty) {
                    return Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        const Text("No hay notificaciones nuevas", style: TextStyle(color: Colors.grey, fontSize: 16)),
                      ],
                    );
                  }
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Color bgColor = isRead ? Colors.transparent : iconColor.withOpacity(0.05);
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: bgColor,
                            borderRadius: BorderRadius.circular(15),
                            border: Border.all(color: isRead ? Colors.grey.shade200 : Colors.transparent),
                          ),
                          child: ListTile(
                            ...
                            title: Text(title, style: TextStyle(fontWeight: isRead ? FontWeight.normal : FontWeight.bold, fontSize: 15)),
                            subtitle: Padding(
                              padding: const EdgeInsets.only(top: 5),
                              child: Text(message, style: TextStyle(fontSize: 13, color: Colors.grey[700])),
                            ),
                            trailing: !isRead 
                              ? const CircleAvatar(radius: 5, backgroundColor: PrimaryPurple) 
