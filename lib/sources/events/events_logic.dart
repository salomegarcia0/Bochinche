...
const List<String> phonePrefixList = [
  '0412',
  '0414',
  '0416',
  '0424',
...
Future<void> createEvent(BuildContext context) async {
  ...
  try {
    ...
    await newEventRef.set({
      ...
      'paymentInfo': {
        'bank': selectedBank ?? '',
        'phone': selectedPhonePrefix != null && paymentPhoneNumberController.text.isNotEmpty
            ? '$selectedPhonePrefix-${paymentPhoneNumberController.text}'
            : '',
        'ci': selectedCIType != null && paymentCINumberController.text.isNotEmpty
